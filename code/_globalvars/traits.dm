...
GLOBAL_LIST_INIT(traits_by_type, list(
	/mob = list(
		"TRAIT_SURGERY_LOW" = TRAIT_SURGERY_LOW, // F13 CHANGE - UNMODULARISABLE
		"TRAIT_SURGERY_MID" = TRAIT_SURGERY_MID, // F13 CHANGE - UNMODULARISABLE
		"TRAIT_SURGERY_HIGH" = TRAIT_SURGERY_HIGH, // F13 CHANGE - UNMODULARISABLE
		...
		"TRAIT_NICE_SHOT" = TRAIT_NICE_SHOT, // F13 CHANGE - UNMODULARISABLE
		"TRAIT_PERFECT_ATTACKER" = TRAIT_PERFECT_ATTACKER, // F13 CHANGE - UNMODULARISABLE
		"TRAIT_BUFFOUT_BUFF" = TRAIT_BUFFOUT_BUFF, // F13 CHANGE - UNMODULARISABLE
		"TRAIT_UNARMED_WEAPON" = TRAIT_UNARMED_WEAPON, // F13 CHANGE - UNMODULARISABLE
		"TRAIT_CANNIBAL" = TRAIT_LONGPORKLOVER, // F13 CHANGE - UNMODULARISABLE
	),
