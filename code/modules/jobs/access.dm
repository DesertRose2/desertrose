...
/proc/get_region_accesses(code)
	switch(code)
		...
		if(2) //security
			return list(ACCESS_SEC_DOORS, ACCESS_WEAPONS, ACCESS_SECURITY, ACCESS_BRIG, ACCESS_ARMORY, ACCESS_FORENSICS_LOCKERS, ACCESS_COURT, ACCESS_LEGION, ACCESS_HOS, ACCESS_NCR, ACCESS_BOS, ACCESS_VTCC, ACCESS_VTCC_SHOP)
		if(3) //medbay
