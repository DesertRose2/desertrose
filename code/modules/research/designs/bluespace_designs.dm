...
/datum/design/bag_holding
	name = "Bag of Holding"
	desc = "A backpack that opens into a localized quantum pocket."
	id = "bag_holding"
	build_type = PROTOLATHE
...
/datum/design/satchel_holding
	...
	desc = "A satchel that opens into a localized quantum pocket."
	id = "satchel_holding"
	build_type = PROTOLATHE
	materials = list(/datum/material/gold = 3000, /datum/material/diamond = 1500, /datum/material/uranium = 250, /datum/material/bluespace = 2000)
...
/datum/design/duffelbag_holding
	...
	desc = "A duffel bag that opens into a localized quantum pocket."
...
/datum/design/bluespace_carrier
	name = "Quantum Jar"
	desc = "A jar used to contain creatures, using quantum compression."
