...
/datum/techweb_node/adv_weaponry
	...
	design_ids = list("pin_loyalty", "bullet_shield", "ecp", "fluxcap", "focusedlenses", "superconductor", "advreceiver", "preassembly", "superalloys", "crusader_rifle", "crusader_laser", "maxson_5mm")
