...
/obj/machinery/mineral/wasteland_vendor/attachments
	...
	icon_state = "generic_idle"
	prize_list = list(
		new /datum/data/wasteland_equipment("Weapon Optics",				/obj/item/attachment/scope,									150),
		new /datum/data/wasteland_equipment("Recoil Compensator",			/obj/item/attachment/recoil_decrease,							100),
		new /datum/data/wasteland_equipment("Improved Barrel",				/obj/item/attachment/bullet_speed,								100),
		new /datum/data/wasteland_equipment("Burst Cam",					/obj/item/attachment/burst_improvement,						200)
		)
	highpop_list = list(
		new /datum/data/wasteland_equipment("Weapon Optics",				/obj/item/attachment/scope,									150),
		new /datum/data/wasteland_equipment("Recoil Compensator",			/obj/item/attachment/recoil_decrease,							100),
