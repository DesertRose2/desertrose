/datum/chemical_reaction/nukacherry
	name = "Nuka Cherry"
	id = "nukacherry"
	results = list(/datum/reagent/consumable/nukacherry = 2)
	required_reagents = list(/datum/reagent/consumable/nuka_cola = 1, /datum/reagent/consumable/cherryjelly = 1)
...
/datum/chemical_reaction/nukaquartz
	...
	required_reagents = list(/datum/reagent/consumable/nuka_cola = 1, /datum/reagent/consumable/milk = 1, /datum/reagent/consumable/sugar = 1)
...
/datum/chemical_reaction/nukafancy
	...
	required_reagents = list(/datum/reagent/consumable/nuka_cola = 1, /datum/reagent/consumable/ethanol/martini = 1, /datum/reagent/consumable/ice = 1)
...
/datum/chemical_reaction/nukalove
	name = "Nuka Love"
	id = "nukalove"
	results = list(/datum/reagent/consumable/ethanol/nukalove = 3)
	required_reagents = list(/datum/reagent/consumable/nuka_cola = 1, /datum/reagent/consumable/ethanol/between_the_sheets = 1, /datum/reagent/consumable/ice = 1)
...
/datum/chemical_reaction/nukaxtreme
	...
	required_reagents = list(/datum/reagent/consumable/ethanol/nukacide = 10, /datum/reagent/consumable/ethanol/nukaquantum = 10, /datum/reagent/consumable/ice = 10)
...
/datum/chemical_reaction/nukafloat
	name = "Nuka Float"
	id = "nukafloat"
	results = list(/datum/reagent/consumable/nukafloat = 3)
	required_reagents = list(/datum/reagent/consumable/nuka_cola = 1, /datum/reagent/consumable/ice = 1, /datum/reagent/consumable/cream = 1)

/datum/chemical_reaction/sunsetfloat
	name = "Sunset Float"
	id = "sunsetfloat"
	results = list(/datum/reagent/consumable/sunsetfloat = 3)
	required_reagents = list(/datum/reagent/consumable/sunset = 1, /datum/reagent/consumable/ice = 1, /datum/reagent/consumable/cream = 1)
