...
//Olllld custom armors. Unsure if these are still in use or not. Just keep these at the BOTTOM of the list since I do not know for sure if these are still used or not.
