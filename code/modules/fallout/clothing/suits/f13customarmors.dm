...
//Custom item - Gurking / Natalie Van De Woestejn
...
//Custom item - Muhsollini / Emily Winona
...
//Custom item - Seabass / Wolf Emerson
...
//Custom item - Muhsollini / Kainat Ali
...
//Olllld custom armors that were supposed to be put into the graveyard ages ago apperantly. Not removing these since I got told that someone may still use them; these should be went through at some point.
