...
/obj/item/clothing/under/f13/ncrcf
	name = "NCRCF fatigues"
	desc = "A cheap worn-in blue dress shirt and slacks. Emblazened on the back are the initials of the NCR Correctional Facility, a meek reminder of who owns you."
	icon_state = "ncrcf"
	item_state = "ncrcf"
	item_color = "ncrcf"
