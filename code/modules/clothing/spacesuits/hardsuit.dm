...
/obj/item/clothing/head/helmet/space/hardsuit/engine
	...
	icon_state = "hardsuit0-engineering"
	item_state = "eng_helm"
	armor = list("tier" = 2, "energy" = 5, "bomb" = 10, "bio" = 100, "rad" = 75, "fire" = 100, "acid" = 75, "wound" = 10)
...
/obj/item/clothing/head/helmet/space/hardsuit/engine/atmos
	...
	armor = list("tier" = 2, "energy" = 5, "bomb" = 10, "bio" = 100, "rad" = 25, "fire" = 100, "acid" = 75, "wound" = 10)
...
/obj/item/clothing/head/helmet/space/hardsuit/engine/elite
	...
	item_state = "ce_helm"
	hardsuit_type = "white"
	armor = list("tier" = 3, "energy" = 5, "bomb" = 50, "bio" = 100, "rad" = 100, "fire" = 100, "acid" = 90, "wound" = 10)
...
/obj/item/clothing/head/helmet/space/hardsuit/syndi
	...
	hardsuit_type = "syndi"
	armor = list("tier" = 6, "energy" = 15, "bomb" = 35, "bio" = 100, "rad" = 50, "fire" = 50, "acid" = 90, "wound" = 25)
	on = FALSE
...
/obj/item/clothing/head/helmet/space/hardsuit/syndi/elite
	...
	armor = list("tier" = 7, "energy" = 25, "bomb" = 55, "bio" = 100, "rad" = 70, "fire" = 100, "acid" = 100, "wound" = 25)
	heat_protection = HEAD
	max_heat_protection_temperature = FIRE_IMMUNITY_MAX_TEMP_PROTECT
...
/obj/item/clothing/head/helmet/space/hardsuit/wizard
	...
	armor = list("tier" = 6, "energy" = 20, "bomb" = 35, "bio" = 100, "rad" = 50, "fire" = 100, "acid" = 100, "wound" = 30)
	heat_protection = HEAD												//Uncomment to enable firesuit protection
	max_heat_protection_temperature = FIRE_IMMUNITY_MAX_TEMP_PROTECT
...
/obj/item/clothing/head/helmet/space/hardsuit/medical
	...
	flash_protect = 0
	armor = list("tier" = 2, "energy" = 5, "bomb" = 10, "bio" = 100, "rad" = 60, "fire" = 60, "acid" = 75, "wound" = 10)
...
/obj/item/clothing/head/helmet/space/hardsuit/rd
	...
	max_heat_protection_temperature = FIRE_SUIT_MAX_TEMP_PROTECT
	armor = list("tier" = 3, "energy" = 5, "bomb" = 100, "bio" = 100, "rad" = 60, "fire" = 60, "acid" = 80, "wound" = 15)
...
/obj/item/clothing/head/helmet/space/hardsuit/security
	...
	item_state = "sec_helm"
	hardsuit_type = "sec"
	armor = list("tier" = 4,"energy" = 10, "bomb" = 10, "bio" = 100, "rad" = 50, "fire" = 75, "acid" = 75, "wound" = 20)
...
/obj/item/clothing/head/helmet/space/hardsuit/security/hos
	...
	hardsuit_type = "hos"
	armor = list("tier" = 5, "energy" = 10, "bomb" = 25, "bio" = 100, "rad" = 50, "fire" = 95, "acid" = 95, "wound" = 25)
...
/obj/item/clothing/head/helmet/space/hardsuit/captain
	...
	armor = list("tier" = 7, "energy" = 25, "bomb" = 50, "bio" = 100, "rad" = 50, "fire" = 100, "acid" = 100, "wound" = 15)
	resistance_flags = FIRE_PROOF | ACID_PROOF
...
/obj/item/clothing/head/helmet/space/hardsuit/ancient
	...
	item_state = "anc_helm"
	armor = list("tier" = 3, "energy" = 0, "bomb" = 50, "bio" = 100, "rad" = 100, "fire" = 100, "acid" = 75, "wound" = 10)
...
/obj/item/clothing/head/helmet/space/hardsuit/soviet
	...
	armor = list("tier" = 5, "energy" = 15, "bomb" = 35, "bio" = 100, "rad" = 20, "fire" = 50, "acid" = 75, "wound" = 15)
...
/obj/item/clothing/suit/space/hardsuit/shielded
	...
	helmettype = /obj/item/clothing/head/helmet/space/hardsuit/security/hos
	allowed = null
	armor = list("tier" = 4, "energy" = 10, "bomb" = 10, "bio" = 100, "rad" = 50, "fire" = 100, "acid" = 100, "wound" = 15)
	resistance_flags = FIRE_PROOF | ACID_PROOF
...
/obj/item/clothing/suit/space/hardsuit/shielded/ctf
	...
	armor = list("tier" = 3, "energy" = 30, "bomb" = 50, "bio" = 100, "rad" = 100, "fire" = 95, "acid" = 95, "wound" = 30)
	slowdown = 0
	max_charges = 5
...
/obj/item/clothing/suit/space/hardsuit/shielded/syndi
	...
	item_state = "syndie_hardsuit"
	hardsuit_type = "syndi"
	armor = list("tier" = 5, "energy" = 15, "bomb" = 35, "bio" = 100, "rad" = 50, "fire" = 100, "acid" = 100, "wound" = 30)
...
/obj/item/clothing/suit/space/hardsuit/shielded/swat
	...
	max_charges = 4
	recharge_delay = 15
	armor = list("tier" = 10, "energy" = 50, "bomb" = 100, "bio" = 100, "rad" = 100, "fire" = 100, "acid" = 100, "wound" = 30)
	strip_delay = 130
	max_heat_protection_temperature = FIRE_IMMUNITY_MAX_TEMP_PROTECT
