...
/obj/item/clothing/head/helmet/space/hardsuit/deathsquad
	...
	armor = list("tier" = 9, "energy" = 50, "bomb" = 100, "bio" = 100, "rad" = 100, "fire" = 100, "acid" = 100, "wound" = 30)
	strip_delay = 130
...
/obj/item/clothing/suit/space/swat
	name = "MK.I SWAT Suit"
	desc = "(VII) A tactical space suit first developed in a joint effort by the defunct IS-ERI and Nanotrasen in 20XX for military space operations. A tried and true workhorse, it is very difficult to move in but offers robust protection against all threats!"
	icon_state = "heavy"
	item_state = "swat_suit"
...
/obj/item/clothing/head/helmet/space/pirate
	...
	icon_state = "pirate"
	item_state = "pirate"
	armor = list("tier" = 5,"energy" = 15, "bomb" = 30, "bio" = 30, "rad" = 30, "fire" = 60, "acid" = 75, "wound" = 30)
	flags_inv = HIDEHAIR
	strip_delay = 40
...
/obj/item/clothing/head/helmet/space/freedom
	...
	armor = list("tier" = 3, "energy" = 25, "bomb" = 100, "bio" = 100, "rad" = 100, "fire" = 80, "acid" = 80, "wound" = 20)
	strip_delay = 130
	max_heat_protection_temperature = FIRE_IMMUNITY_MAX_TEMP_PROTECT
...
/obj/item/clothing/suit/space/hardsuit/carp
	...
	armor = list("linemelee" = -50, "bullet" = 0, "laser" = 0, "energy" = 0, "bomb" = 0, "bio" = 100, "rad" = 75, "fire" = 60, "acid" = 75, "wound" = 5) //As whimpy whimpy whoo
...
/obj/item/clothing/suit/space/hardsuit/ert/paranormal/inquisitor/old
	...
	armor = list("tier" = 6, "energy" = 40, "bomb" = 40, "bio" = 80, "rad" = 80, "fire" = 60, "acid" = 60, "wound" = 20)
	slowdown = 0.8
...
/obj/item/clothing/head/helmet/space/fragile
	...
	armor = list("tier" = 1, "energy" = 0, "bomb" = 0, "bio" = 0, "rad" = 10, "fire" = 0, "acid" = 0, "wound" = 5)
	strip_delay = 65
...
/obj/item/clothing/suit/space/hunter
	...
	icon_state = "hunter"
	item_state = "swat_suit"
	armor = list("tier" = 6, "energy" = 50, "bomb" = 100, "bio" = 100, "rad" = 100, "fire" = 100, "acid" = 100, "wound" = 25)
	strip_delay = 130
	resistance_flags = FIRE_PROOF | ACID_PROOF
