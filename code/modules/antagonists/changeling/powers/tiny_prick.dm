...
/obj/effect/proc_holder/changeling/sting/false_armblade/sting_action(mob/user, mob/target)
	...
	target.visible_message(SPAN_WARNING("A grotesque blade forms around [target.name]\'s arm!"), "<span class='userdanger'>Your arm twists and mutates, transforming into a horrific monstrosity!</span>", "<span class='italics'>You hear organic matter ripping and tearing!</span>")
