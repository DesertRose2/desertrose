...
/obj/item/clothing/head/helmet/clockwork/ratvar_act()
	if(GLOB.ratvar_awakens)
		armor = getArmor(melee = 100, bullet = 100, laser = 100, bomb = 100, bio = 100, rad = 100, acid = 100)
		clothing_flags |= STOPSPRESSUREDAMAGE
		max_heat_protection_temperature = FIRE_IMMUNITY_MAX_TEMP_PROTECT
		min_cold_protection_temperature = SPACE_HELM_MIN_TEMP_PROTECT
	else if(GLOB.ratvar_approaches)
		armor = getArmor(melee = 70, bullet = 80, laser = 10, bomb = 70, bio = 0, rad = 0, acid = 100)
		clothing_flags |= STOPSPRESSUREDAMAGE
		max_heat_protection_temperature = FIRE_IMMUNITY_MAX_TEMP_PROTECT
		min_cold_protection_temperature = SPACE_HELM_MIN_TEMP_PROTECT
	else
		armor = getArmor(melee = 60, bullet = 70, laser = 0, bomb = 60, bio = 0, rad = 0, acid = 100)
		clothing_flags &= ~STOPSPRESSUREDAMAGE
...
/obj/item/clothing/gloves/clockwork/ratvar_act()
	if(GLOB.ratvar_awakens)
		...
		armor = getArmor(melee = 80, bullet = 70, laser = 0, bomb = 60, bio = 0, rad = 0, acid = 100)
		clothing_flags &= ~STOPSPRESSUREDAMAGE
		max_heat_protection_temperature = initial(max_heat_protection_temperature)
		min_cold_protection_temperature = initial(min_cold_protection_temperature)
