...
/obj/item/organ/heart/gland/heal/proc/reject_implant(obj/item/organ/cyberimp/implant)
	owner.visible_message(SPAN_WARNING("[owner] vomits up his [implant.name]!"), "<span class='userdanger'>You suddenly vomit up your [implant.name]!</span>")
...
/obj/item/organ/heart/gland/heal/proc/replace_liver(obj/item/organ/liver/liver)
	if(liver)
		owner.visible_message(SPAN_WARNING("[owner] vomits up his [liver.name]!"), "<span class='userdanger'>You suddenly vomit up your [liver.name]!</span>")
		owner.vomit(0, TRUE, TRUE, 1, FALSE, FALSE, FALSE, TRUE)
		liver.Remove()
...
/obj/item/organ/heart/gland/heal/proc/replace_lungs(obj/item/organ/lungs/lungs)
	if(lungs)
		owner.visible_message(SPAN_WARNING("[owner] vomits up his [lungs.name]!"), "<span class='userdanger'>You suddenly vomit up your [lungs.name]!</span>")
		owner.vomit(0, TRUE, TRUE, 1, FALSE, FALSE, FALSE, TRUE)
		lungs.Remove()
...
/obj/item/organ/heart/gland/heal/proc/replace_eyes(obj/item/organ/eyes/eyes)
	if(eyes)
		owner.visible_message(SPAN_WARNING("[owner]'s [eyes.name] fall out of their sockets!"), "<span class='userdanger'>Your [eyes.name] fall out of their sockets!</span>")
...
/obj/item/organ/heart/gland/heal/proc/finish_replace_eyes()
	...
	owner.visible_message(SPAN_WARNING("A pair of new eyes suddenly inflates into [owner]'s eye sockets!"), "<span class='userdanger'>A pair of new eyes suddenly inflates into your eye sockets!</span>")

/obj/item/organ/heart/gland/heal/proc/replace_limb(body_zone, obj/item/bodypart/limb)
	if(limb)
		owner.visible_message(SPAN_WARNING("[owner]'s [limb.name] suddenly detaches from [owner.p_their()] body!"), "<span class='userdanger'>Your [limb.name] suddenly detaches from your body!</span>")
...
/obj/item/organ/heart/gland/heal/proc/replace_blood()
	owner.visible_message(SPAN_WARNING("[owner] starts vomiting huge amounts of blood!"), "<span class='userdanger'>You suddenly start vomiting huge amounts of blood!</span>")
...
/obj/item/organ/heart/gland/heal/proc/replace_chest(obj/item/bodypart/chest/chest)
	if(chest.status == BODYPART_ROBOTIC)
		owner.visible_message(SPAN_WARNING("[owner]'s [chest.name] rapidly expels its mechanical components, replacing them with flesh!"), "<span class='userdanger'>Your [chest.name] rapidly expels its mechanical components, replacing them with flesh!</span>")
