...
/obj/item/borg/lollipop/proc/dispense(atom/A, mob/user)
	...
	if(into_hands)
		user.visible_message(SPAN_NOTICE("[user] dispenses a treat into the hands of [A]."), SPAN_NOTICE("You dispense a treat into the hands of [A]."), "<span class='italics'>You hear a click.</span>")
	else
		user.visible_message(SPAN_NOTICE("[user] dispenses a treat."), SPAN_NOTICE("You dispense a treat."), "<span class='italics'>You hear a click.</span>")
