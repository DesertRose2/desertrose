/obj/structure/toilet
	name = "toilet"
	desc = "A toilet. Used for swirlies and storing contraband, mainly."
...
/obj/structure/toilet/on_attack_hand(mob/living/user, act_intent = user.a_intent, unarmed_attack_flags)
	...
	if(swirlie)
		...
		swirlie.visible_message(SPAN_DANGER("[user] slams the toilet seat onto [swirlie]'s head!"), "<span class='userdanger'>[user] slams the toilet seat onto your head!</span>", "<span class='italics'>You hear reverberating porcelain.</span>")
		...
		if(user.grab_state >= GRAB_AGGRESSIVE)
			...
			if(!swirlie)
				if(open)
					GM.visible_message(SPAN_DANGER("[user] starts to give [GM] a swirlie!"), "<span class='userdanger'>[user] starts to give you a swirlie...</span>")
					swirlie = GM
					if(do_after(user, 30, 0, target = src))
						GM.visible_message(SPAN_DANGER("[user] gives [GM] a swirlie!"), "<span class='userdanger'>[user] gives you a swirlie!</span>", "<span class='italics'>You hear a toilet flushing.</span>")
						if(iscarbon(GM))
					...
					GM.visible_message(SPAN_DANGER("[user] slams [GM.name] into [src]!"), "<span class='userdanger'>[user] slams you into [src]!</span>")
