...
GLOBAL_LIST_INIT(footstep, list(
	...
	FOOTSTEP_SAND = list(list(
		...
		'sound/f13effects/footsteps/sand/sand4.ogg'), 70, 1),
	...
	FOOTSTEP_RUST = list(list(
		...
		'sound/f13effects/footsteps/metal/hull5.ogg'), 90, 1),
	...
	FOOTSTEP_SNOW = list(list(
		...
		'sound/f13effects/footsteps/snow/snow5.ogg'), 80, 1),
	FOOTSTEP_GRAVEL = list(list(
		...
		'sound/f13effects/footsteps/gravel/gravel4.ogg'), 65, 1),
	FOOTSTEP_ROAD = list(list(
		...
		'sound/f13effects/footsteps/road/road_walk6.ogg'), 45, 1),
))
...
GLOBAL_LIST_INIT(barefootstep, list(
	...
	FOOTSTEP_RUST = list(list(
		...
		'sound/f13effects/footsteps/metal/hull3.ogg',
		'sound/f13effects/footsteps/metal/hull4.ogg',
		'sound/f13effects/footsteps/metal/hull5.ogg'), 50, 1),
))
...
GLOBAL_LIST_INIT(barefootstep, list(
	...
	FOOTSTEP_GRAVEL_BAREFOOT = list(list(
		...
		'sound/f13effects/footsteps/gravel/gravel2.ogg',
		'sound/f13effects/footsteps/gravel/gravel3.ogg',
		'sound/f13effects/footsteps/gravel/gravel4.ogg'), 70, 1),
	FOOTSTEP_GRASS = list(list(
		'sound/effects/footstep/grass1.ogg',
		'sound/effects/footstep/grass2.ogg',
		'sound/effects/footstep/grass3.ogg',
...
GLOBAL_LIST_INIT(heavyfootstep, list(
	...
	FOOTSTEP_RUST = list(list(
		...
		'sound/f13effects/footsteps/metal/hull3.ogg',
		'sound/f13effects/footsteps/metal/hull4.ogg',
		'sound/f13effects/footsteps/metal/hull5.ogg'), 120, 2),
))
*/
