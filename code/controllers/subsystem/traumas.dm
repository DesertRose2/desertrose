...
/datum/controller/subsystem/traumas/Initialize()
	...
	phobia_types = list("spiders", "space", "security", "clowns", "greytide", "lizards",
						...
						"aliens", "strangers", "birds", "falling", "anime", "mimes", "cats", "eye"
						)
	...
	phobia_objs = list("snakes" = typecacheof(list(/obj/item/rod_of_asclepius)),
					...
					"skeletons" = typecacheof(list(/obj/item/organ/tongue/bone, /obj/item/clothing/suit/armor/f13/bone, /obj/item/stack/sheet/bone,
